...
@section('content')
  ...
  <link href="{{ asset('css/styles.css') }}" rel="stylesheet">
      <div id="comboboxTasks" style="margin-top: 10px"></div>
      <div id="categoryLegend" style="margin-top: 10px; width:250px"></div>
    ...
    <div style="margin-top: 5px; margin-left: 50px">
      <div id="taskTableByAllSelectedClients" style="margin-top: 10px"></div>
        ...
        <button class="buttonReloadPage" type="button">Reload Page</button>
...
<script src="/js/jquery-3.4.1.js"></script>
    <script type="text/javascript">
        $(document).ready(function() {
          ...
          function makeCategoryLegend(){
            ...
            for(var i=0; i<categories.length; i++){
              table_body += '<li style=" padding: 5px; margin-right:20px; display:inline; background-color:' + categories[i].color + '">' + categories[i].name + '</li>';
            }
            table_body += '</ul>';
      ...
      // all clicked fields change to the selected task 
        /*
        $('.fixedTable-body td').on('click',function(e){
          var thisCell = $(this);
          $(this).css("background-image", "grey !important");

          console.log(thisCell);

          var classList = thisCell.attr('class').split(/\s+/);
          console.log(classList[1]); // class id
          //console.log(thisCell.html());
          //console.log(thisCell.index());

          //$(this).css("background-color","grey");
          $(this).toggleClass('clicked');
          console.log($(this).parent().prevAll().length);   // ALL PREVIOUS FIELDS

          // var id = classList[1]; var task_id = "2";
          // url:'/tasks2/table/changeCell', data:{id:id, task_id: task_id},

          var selectedTask = $('#comboboxTasks option:selected').val();
          ...
          $.ajax({
            type:'POST',
            url:'/tasks2/changeTaskCellCombobox',
      ...
      $(document).on('change',"#comboboxTasksCell", function(e){
        ...
        $.ajax({
          type:'POST',
          url:'/tasks2/changeTaskCellComboboxInCell',
          data:{id:id, task_id: task_id},
          success:function(data){
            //alert(data.success);
          }
      ...
      $(document).on('change',"#comboboxCategoriesCell", function(e){
        ...
        $.ajax({
          type:'POST',
          url:'/tasks2/changeCategoryCellComboboxInCell',
