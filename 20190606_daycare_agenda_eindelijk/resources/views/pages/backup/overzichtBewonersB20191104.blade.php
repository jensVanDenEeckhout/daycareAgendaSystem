      ...
      <div class="container" >
        <div class="content">
          ...
          <div class="overviewCallToActionsHomePage">
            ...
            <form class="form aanwezigForm" action="{{URL::to('/2/overzicht/taken')}}" method="get">      
              {{ csrf_field()}}

                    <button class="button button-aanwezig" formaction="{{URL::to('/2/aanwezig/personeel')}}">
                      <i class="fa fa-heartbeat" style="color:#A52A2A" aria-hidden="true"></i>
                      <p>Aanwezig</p>
                    </button>
            </form>
                ...
                // attendance
                  ...
                  for(var i in employees){
                    body +=
                      ...
                      '<input  id="' +  employees[i]['name'] + '" name="' + employees[i]['name'] + '" value="' + employees[i]['id'] + '" type="checkbox"/>';


                      if(employees[i]['attendance'] === 1){
                        body += '<label class="checked" for="' + employees[i]['name'] + '">' + employees[i]['name']  + '</label>' +
                        '</div>'
                      }else if(employees[i]['attendance'] === 0){
                        body += '<label for="' + employees[i]['name'] + '">' + employees[i]['name']  + '</label>' +
                        '</div>'
                      }
                  }
                  $('#checkboxesEmployees').append(body);
