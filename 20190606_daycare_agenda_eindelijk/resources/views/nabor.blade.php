      ...
      <div class="wrapper">
            ...
            <nav>
                  ...
                  <span class="brand brandnumber">
                        <p style="color:#f44336;">0479 05 43 78</p>
                  </span>                  

                  <ul id="menu">

                        <li><a href="work.html" style="color:#FFD700;"><i >Projecten</i><span>.</span></a></li>
                        <li><a href="about.html" style="color:#90EE90">Certificaten<span>.</span></a></li>
                        <li><a href="contact.html" style="color:#AFEEEE">Contact<span>.</span></a></li>
                  </ul>
            ...
            <div class="hero">
                  <div class="header">
                        <h1 class="line anim-typewriter">Sanitair, elektriciteit, verwarming</h1>
                  </div>
                  ...
                  <div class="slideshow">
                        ...
                        <section class="demo_wrapper">
                                    ...
                                    <article class="demo_block">
                                          ...
                                          -->
                                          <ul id="demo1">
                                                <li><a href="#slide1"><img src="images/sanitair/resized/1.png" alt="Sanitair"></a></li>

                                                <li><a href="#slide2"><img src="images/sanitair/resized/2.png"  alt="Elektriciteit"></a></li>

                                                <li><a href="#slide3"><img src="images/sanitair/resized/3.png" alt="Centrale <a href='#link'>verwarming</a>"></a>
            ...
            <div class="container-fluid">
                  ...
                  <div class="three_column_section">
                        <div>
                              <h2> Sanitair </h2>
                              <p> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Saepe molestias tempora repudiandae nam, sequi. Fugiat sunt quasi facilis asperiores sint.</p>
                        </div>
                        <div>
                              <h2> Elektriciteit </h2>     
                              <p> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Saepe molestias tempora repudiandae nam, sequi. Fugiat sunt quasi facilis asperiores sint.</p>                         
            ...
            <div class="footer">
                  <div class="container">
                        ...
                        <div class="collab">
                              <div class="row">
                                    <div class="col-lg-12">
                                          <p class="wow fadeInUp">Vraag hier u gratis offerte aan.</p>
                                    </div>
                              </div>
                        </div>
                        ...
                        <div class="info">
                              <div class="row">
                                    <div class="col-lg-4" id="personal">
                                          ...
                                          <h4 class="wow fadeInUp" data-wow-delay="0.2s">0479 05 43 78</h4>
                                          <br><br>
                                    </div>

                                    <div class="col-lg-4" id="media">
                                          <p class="wow fadeInUp" data-wow-delay="0s">volg me</p>
                                    ...
                                    <div class="col-lg-4" id="address">
                                          ...
                                          <h4 class="wow fadeInUp" data-wow-delay="0.2s">nabor.boone@gmail.com</h4>
                                          <br><br>
                                    </div>
                              </div>
                        </div>
