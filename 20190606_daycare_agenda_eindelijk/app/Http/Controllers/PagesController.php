...
class PagesController extends Controller
{
    ...
    public function showTasksAndEmployees(){
        $tasks = Task::orderBy('name','asc')->pluck('name','id');
    ...
    public function toevoegenTaak(Request $request){
        ...
        return $this->showTasksAndEmployees();


    }


    public function verwijderenTaak(Request $request){


        $task_id = $request->input('tasks');
    ...
    public function verwijderenPersoneel(Request $request){
    ...
    public function toevoegenPersoneel(Request $request){
        ...
        $employee_permission = $request->input('employee_permission');
        ...
        $user->permission = $employee_permission;
        $user->save();
