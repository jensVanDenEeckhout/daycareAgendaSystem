...
class PagesController extends Controller
{
    ...
    public function saveTasks(Request $request){
      ...
      //dd($ids);
        ...
        public function bewerkenTaken(Request $request){
            $ids = $request->all(); // gets (id of day of the week) , (all selected users) , (button) and (token)
  $employees = Employee::all();
            ...
            return view('pages.bewerkenTaken')
            ->with('employees',$employees)
            ->with('clients',$clients)
            //->with('cells',$cells)
        ...
        //replace
        public function overzichtTaken(Request $request){
            $ids = $request->all(); // gets (id of day of the week) , (all selected users) , (button) and (token)
            //dd($ids);
            $day = $request->get('dayOfTheWeek');
            //dd($ids);
            ...
            return view('pages.overzichtTaken')
            ->with('clients',$clients)
            //->with('cells',$cells)
            ->with('cellsGroupedByClient',$cellsGroupedByClient)
            ->with($time)
